...
@ApplicationScoped
@AllArgsConstructor
public class ZoneGroupRelCreated implements EventHandler {

    final ZoneGroupRelCreated proxy;
    final ZoneGroupRelService rels;

    @Override
    public EventType getType() {
        return EventType.ZONE_GROUP_REL_CREATED;
    }
