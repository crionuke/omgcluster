...
public enum EventType {
    ...
    SIM_INSTANCE_REL_CREATED(30),
    SIM_INSTANCE_REL_ACTIVATED(31),
    SIM_INSTANCE_REL_SUSPENDED(32),
    SIM_INSTANCE_REL_DELETED(33),
    ZONE_INSTANCE_REL_CREATED(34),
    ZONE_INSTANCE_REL_ACTIVATED(35),
    ZONE_INSTANCE_REL_SUSPENDED(36),
    ZONE_INSTANCE_REL_DELETED(37);
